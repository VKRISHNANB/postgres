...
values (10001,'John','Tom'),(10002,'Sam','Manuel'),(10003,'Thomas','Henry')
--
...
GO
-- Global Temp Table
create table ##gt1(c1 integer)
insert into ##gt1 values (1000),(2000),(3000)
select * from ##gt1
--
...
GO
-- Clean up
--DROP TABLE @temp -- Not a table to drop
GO
