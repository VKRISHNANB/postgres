...
insert into ExamResult values ('Rak','Social',80)

insert into ExamResult values('Sam','Maths',90)
insert into ExamResult values ('Sam','Science',80)
...
From ExamResult
order by name,Quartile,subject

select Name,Subject,Marks,
NTILE(3) over(partition by subject order by Marks desc)Quartile
From ExamResult
