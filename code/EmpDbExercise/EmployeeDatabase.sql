...
/****** Object:  Database [EmployeeDetails]    Script Date: 03/24/2015 12:53:30 ******/
CREATE DATABASE [EmployeeDetails] ON  PRIMARY 
( NAME = N'EmployeeDetails', FILENAME = N'c:\Program Files\Microsoft SQL Server\MSSQL10_50.SQLEXPRESS\MSSQL\DATA\EmployeeDetails.mdf' , SIZE = 2048KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'EmployeeDetails_log', FILENAME = N'c:\Program Files\Microsoft SQL Server\MSSQL10_50.SQLEXPRESS\MSSQL\DATA\EmployeeDetails_log.ldf' , SIZE = 1024KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO

ALTER DATABASE [EmployeeDetails] SET COMPATIBILITY_LEVEL = 100
GO
...
ALTER DATABASE [EmployeeDetails] SET AUTO_CREATE_STATISTICS ON 
GO
